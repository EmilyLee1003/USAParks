								...
								<div className="card h-100">
									...
									<div className="card-body">
										...
										<p className="card-text">
											Description: Stretching between Shelter Cove to the south
											and the Mattole River to the north, the Lost Coast is a
											wild land of forests, fog, waves, and sand.
										</p>
							...
							<div className="col-lg-4 col-sm-6 mb-4">
								<div className="card h-100">
									...
									<div className="card-body">
										...
										<p className="card-text">
											Description: One of the best hikes in Yosemite National
											Park, this trail provides close-up views of Yosemite's
											most spectacular waterfall, as well as panoramic vistas of
											the valley floor
										</p>
								...
								<div className="card h-100">
									...
									<div className="card-body">
										...
										<p className="card-text">
											...
											descends from a primeval forest that existed when
							...
							<div className="col-lg-4 col-sm-6 mb-4">
								<div className="card h-100">
									...
									<div className="card-body">
										...
										<p className="card-text">
											Description: Pomo Canyon Trail climbs through a lush
											redwood forest, then it follows along a wooded ridge with
							...
							<div className="col-lg-4 col-sm-6 mb-4">
								<div className="card h-100">
									...
									<div className="card-body">
										...
										<p className="card-text">
											Description: Stretching between Shelter Cove to the south
											and the Mattole , the Lost Coast is a wild land of
											forests, fog, waves, and sand.
										</p>
										<p className="card-text">Location: Humboldt, CA</p>
