...
{/* <!-- Basthead--> */}
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-8 mx-auto">
                    <h2 className="text-white mb-4">Welsome Username!</h2>
                ...
                <div id="content" className="content p-0">
                    <div className="profile-header">
                        ...
                        <div className="profile-header-content">
                            ...
                            {/* <a className="btn btn-primary js-scroll-trigger" href="#about">Edit Picture</a> */}
                        </div>
                    </div>
                    <br></br>
                    <br></br>
    ...
    {/* <!-- Page Heading --> */}
    <h1 id="myTrails"className="my-4">My Trails:
        ...
        <div className="col-lg-4 col-sm-6 mb-4">
            <div className="card h-100">
                ...
                <div className="card-body">
                    ...
                    <br></br>
                    <a className="btn btn-primary js-scroll-trigger" href="#about">Remove Trail</a>
                </div>
            </div>
        </div>
        {/* <!-- Trail 2 --> */}
