					...
					<div className="col-lg-8 mx-auto">
						...
						<p className="text-white-50">
							...
							<a href="https://www.npca.org/articles/magazine"
								>Learn more about resources here</a
							>
						</p>
					</div>
				</div>
						...
						<div className="carousel-inner" role="listbox">
							...
							>
								<div className="carousel-caption d-none d-md-block">
									...
									<a className="adSpace" href="https://www.patagonia.com/stories/"
										>Visit Here</a
									>
								</div>
							</div>
...
{/* 
				...
				<section className="py-5">
					<div className="container">
						...
						<p className="lead">
							An area on the website we we can partner with other companies,
							organizations, conservations, state governemnts etc. to advertise
							and promote wildlife and land preservation and attraction.
						...
						<div className="bg-black text-center h-100 project">
							<div className="d-flex h-100">
								...
								>
									...
									<p className="mb-0 text-white-50">
										Yet another example of where you can put an image of a news
										story alog with a discription and a link to the article.
									</p>
									<br />
									<a
										className="btn btn-primary js-scroll-trigger"
		...
		<section className="contact-section bg-black">
			<div className="container">
				...
				<div className="social d-flex justify-content-center">
					...
					></a>
					<a className="mx-2" href="https://www.facebook.com/USInterior/?ref=py_c"
						><i className="fab fa-facebook-f"></i
					></a>
					<a className="mx-2" href="https://github.com/EmilyLee1003/nationalParks"
